...
* Create a metaweb with a Lotka-Volterra interaction matrix structure, I added one last column with intrinsic growth rate. 
...
* Set the initial conditions and simulate the model with no migration during 1000 time steps
...
```
   ...
   * We can calculate the proportions of the different types of interactions using the metaweb matrix and the vector of species present, in this case all species 
...
* Check the results of the simulation: the abundances and the proportion of interactions, at the last time step 
...
1. Saravia, L. A., Marina, T. I., Kristensen, N. P., De Troch, M., & Momo, F. R. (2022). Ecological network assembly: How the regional metaweb influences local food webs. Journal of Animal Ecology, 91(3), 630–642. https://doi.org/10.1111/1365-2656.13652

2. Gravel, D., Massol, F., Canard, E., Mouillot, D., & Mouquet, N. (2011). Trophic theory of island biogeography. Ecology Letters, 14(10), 1010–1016. https://doi.org/10.1111/j.1461-0248.2011.01667.x
