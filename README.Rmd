...
This package simulates the assembly of ecological networks as food-web from a regional web. It uses a generalized Lotka-Volterra stochastic model.
...
1) Create a Lotka-Volterra interaction matrix with intrinsec growth rate as the last column 
